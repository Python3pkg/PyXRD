...
latex_documents = [
  ('index', 'PyXRD.tex', 'PyXRD Documentation',
   'Mathijs Dumon', 'manual'),
]
...
man_pages = [
    ('index', 'pyxrd', 'PyXRD Documentation',
     ['Mathijs Dumon'], 1)
]
...
texinfo_documents = [
  ('index', 'PyXRD', 'PyXRD Documentation',
   'Mathijs Dumon', 'PyXRD', 'One line description of project.',
   'Miscellaneous'),
]
