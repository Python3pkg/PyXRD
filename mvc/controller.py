...
class Controller(Observer):
    ...
    def adapt(self, *args):
        ...
        if n == 0:
            ...
            for prop in [p for p in props if p.name not in self.__user_props]:
            ...
            if not (isinstance(args[0], bytes) and isinstance(args[1], bytes)):
    ...
    def __autoconnect_signals(self):
        ...
        for name in dir(self):
            ...
            if (not isinstance(method, collections.Callable)): continue
